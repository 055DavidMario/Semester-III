...
void insertNode(int val, Node *&currentNode){//currentNode untuk mengetahui posisi/letak Node
	if(currentNode==NULL){
		...
		insertNode(val, currentNode->left);//disebut sebagai fungsi rekursif (manggil diri sendiri) + parameter by reference
	}
	else if(val > currentNode->value){
